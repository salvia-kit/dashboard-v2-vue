<template>
  <div>
    ...
    <div
      class="p-4 font-normal rounded-2xl"
    ...
    >
      <div class="flex justify-end pb-2 mb-6 border-b border-gray-600">
        ...
        <div class="mx-auto flex">
          <span class="relative text-base">
            <span
              class="h-2 w-2 absolute rounded-full top-1 left--2 bg-green-400"
            />
      ...
      <div class="flex justify-end pb-2 mb-6 border-b border-gray-600">
        ...
        <div class="mx-auto flex">
          <span class="relative text-base">
            <span
              class="h-2 w-2 absolute rounded-full top-1 left--2 bg-indigo-400"
            />
            <span class="pl-4">Updated</span>
          </span>
        </div>
